...
#define	AE_BLK_LVL_VAL_PT0			(0x0  )
#define	AE_BLK_LVL_VAL_PT1			(0x0  )
#define	AE_BLK_LVL_VAL_PT2			(0x10 )
...
// WDR common ---------------------------------------
//WDR-LONG
#define	AE_WDR_SENS_AGC_LMT		(750)

#define	AE_WDR_LTGT_GAIN			(0x3  )								// WDR Long Brightness target gain
#define	AE_WDR_LTGT_OFST			(0x20 )  							// WDR Long Brightness target offset
...
#define	AE_WDR_STGT_OFST			(0x18 )								// WDR Short Brightness target offset
...
#define AE_WDR_LTGT_DCRS_AGC_PT0	(0x0  )
#define AE_WDR_LTGT_DCRS_AGC_PT1	(0x40 )
#define AE_WDR_LTGT_DCRS_AGC_PT2	(0x100)
                                           
#define AE_WDR_LTGT_DCRS_VAL_PT0	(0x0  )
#define AE_WDR_LTGT_DCRS_VAL_PT1	(0x20 )
#define AE_WDR_LTGT_DCRS_VAL_PT2	(0x30 )
                                           
#define	AE_WDR_CLP_AGC_PT0			(0x000)
#define	AE_WDR_CLP_AGC_PT1			(0x040)
#define	AE_WDR_CLP_AGC_PT2			(0x090)
                                	       
#define	AE_WDR_CLP_VAL_PT0			(0x150)
#define	AE_WDR_CLP_VAL_PT1			(0x150)
#define	AE_WDR_CLP_VAL_PT2			(0x150)
                                	                                                         
#define AE_WDR_SATLV_AGC_PT0		(0x800)
#define AE_WDR_SATLV_AGC_PT1		(0x1500)
                                	                                                         
#define AE_WDR_SATLV_VAL_PT0		(0x0  )
#define AE_WDR_SATLV_VAL_PT1		(0x500)
...
#define	AE_SENS_WDR_AGC_LMT			(600)
...
#define AWB_VSP						(0x30 )                                     // AWB detection area Y start
#define AWB_VW						(0x400)                        				// AWB detection area Y end
...
#define AWB_WDR_AGC_MIN				(0x100)									  	// Chroma AGC position for maximum weight
#define AWB_WDR_AGC_MAX				(0x1C0)									  	// Chroma AGC position for minimum weight
                            		
#define AWB_AGC_WGT_MAX				(0x100)										// Chroma maximum weight (100% = 0x100)
#define AWB_AGC_WGT_MIN				(0x70 )   									// Chroma minimum weight
...
#define AWB_YSLICE					0x15										// White Y slice
#define AWB_YCLIP					0x150       								// White Y clip
...
#define	AWB_TEMP_DR_L				(0x49E)
#define	AWB_TEMP_DR_M				(0x320)
#define AWB_TEMP_DR_H				(0x299)
...
#define DNR_WDR_AGC_PT0				(0x000)
#define DNR_WDR_AGC_PT1				(0x0C0)
#define DNR_WDR_AGC_PT2				(0x150)
...
#define DNR_AGC_OFST_MVAL0			(0x03)
#define DNR_AGC_OFST_MVAL1			(0x15)
#define DNR_AGC_OFST_MVAL2			(0x20)
...
#define SHP_WDR_AGC_PT1				(0x080)
#define SHP_WDR_AGC_PT2				(0x100)
                                	       
//APT_PT0                       	       
#define APT55_TH1_PT0				(0x90 )
#define APT55_TH2_PT0				(0x200)
#define APT55_TH3_PT0				(0x90 )
#define APT55_GAIN1N_PT0			(0x40 )	
#define APT55_GAIN2N_PT0			(0x40 )
#define APT55_GAIN1P_PT0			(0x40 )	
#define APT55_GAIN2P_PT0			(0x40 )
                                	       
#define APT33_SLIC_PT0				(0x08 )
#define APT33_CLIP_PT0				(0x90 )
#define APT33_GAIN_PT0				(0x90 )
...
#define APT55_GAIN1P_PT1			(0x10 )
#define APT55_GAIN2P_PT1			(0x10 )
                                	       
#define APT33_SLIC_PT1				(0x20 )
...
// ACE - WDR                    	      						
#define ACE_WDR_TH1_VAL_PT0			(0x5 )						// ACE Dark Area Strength minimum value of WDR (0x0 ~ 0xff)
#define ACE_WDR_TH1_VAL_PT1			(0x5 )						// ACE Dark Area Strength maximum value  of WDR (0x0 ~ 0xff)
#define ACE_WDR_TH1_VAL_PT2			(0x0 )						// ACE Dark Area Strength maximum value  of WDR (0x0 ~ 0xff)
                                	      						
#define ACE_WDR_TH2_VAL_PT0			(0x9 )						// ACE Bright Area Strength minimum value  of WDR (0x0 ~ 0xff)
#define ACE_WDR_TH2_VAL_PT1			(0x9 )						// ACE Bright Area Strength maximum value  of WDR (0x0 ~ 0xff)
...
#define CES_TH_VAL_PT0 				(0x3F)
#define CES_TH_VAL_PT1 				(0x20)
