...
#define OSD_OFF()		/*if(MP(MpCamTitleOn)==MN_CT_OFF) 	FONT_ONw(0)*/
...
#define DrawClrStr(STR,...)	{ DISPCLRSTR(_S(STR),__VA_ARGS__); }
...
//----------------------------------------------------------------------------------------
// Menu
#define S_LIST1(T,O1)			(T)_S(O1)
#define S_LIST2(T,O1, ...)		(T)_S(O1),S_LIST1(T,__VA_ARGS__)
#define S_LIST3(T,O1, ...)		(T)_S(O1),S_LIST2(T,__VA_ARGS__)
#define S_LIST4(T,O1, ...)		(T)_S(O1),S_LIST3(T,__VA_ARGS__)
#define S_LIST5(T,O1, ...)		(T)_S(O1),S_LIST4(T,__VA_ARGS__)
#define S_LIST6(T,O1, ...)		(T)_S(O1),S_LIST5(T,__VA_ARGS__)
#define S_LIST7(T,O1, ...)		(T)_S(O1),S_LIST6(T,__VA_ARGS__)
#define S_LIST8(T,O1, ...)		(T)_S(O1),S_LIST7(T,__VA_ARGS__)
#define S_LIST9(T,O1, ...)		(T)_S(O1),S_LIST8(T,__VA_ARGS__)
#define S_LIST10(T,O1, ...)		(T)_S(O1),S_LIST9(T,__VA_ARGS__)
#define S_LIST11(T,O1, ...)		(T)_S(O1),S_LIST10(T,__VA_ARGS__)
#define S_LIST12(T,O1, ...)		(T)_S(O1),S_LIST11(T,__VA_ARGS__)
#define S_LIST13(T,O1, ...)		(T)_S(O1),S_LIST12(T,__VA_ARGS__)
#define S_LIST14(T,O1, ...)		(T)_S(O1),S_LIST13(T,__VA_ARGS__)
#define S_LIST15(T,O1, ...)		(T)_S(O1),S_LIST14(T,__VA_ARGS__)
#define S_LIST16(T,O1, ...)		(T)_S(O1),S_LIST15(T,__VA_ARGS__)
#define S_LIST17(T,O1, ...)		(T)_S(O1),S_LIST16(T,__VA_ARGS__)
#define S_LIST18(T,O1, ...)		(T)_S(O1),S_LIST17(T,__VA_ARGS__)
#define S_LIST19(T,O1, ...)		(T)_S(O1),S_LIST18(T,__VA_ARGS__)
#define S_LIST20(T,O1, ...)		(T)_S(O1),S_LIST19(T,__VA_ARGS__)
#define S_LIST21(T,O1, ...)		(T)_S(O1),S_LIST20(T,__VA_ARGS__)

//#define uStrs1(O1)				(UINT)_S(O1)
//#define uStrs2(O1, ...)			(UINT)_S(O1),uStrs1(__VA_ARGS__)
//#define uStrs3(O1, ...)			(UINT)_S(O1),uStrs2(__VA_ARGS__)
//#define uStrs4(O1, ...)			(UINT)_S(O1),uStrs3(__VA_ARGS__)
//#define uStrs5(O1, ...)			(UINT)_S(O1),uStrs4(__VA_ARGS__)
//#define uStrs6(O1, ...)			(UINT)_S(O1),uStrs5(__VA_ARGS__)
//#define uStrs7(O1, ...)			(UINT)_S(O1),uStrs6(__VA_ARGS__)
//#define uStrs8(O1, ...)			(UINT)_S(O1),uStrs7(__VA_ARGS__)
//#define uStrs9(O1, ...)			(UINT)_S(O1),uStrs8(__VA_ARGS__)
//#define uStrs10(O1, ...)		(UINT)_S(O1),uStrs9(__VA_ARGS__)
//#define uStrs11(O1, ...)		(UINT)_S(O1),uStrs10(__VA_ARGS__)
//#define uStrs12(O1, ...)		(UINT)_S(O1),uStrs11(__VA_ARGS__)
//#define uStrs13(O1, ...)		(UINT)_S(O1),uStrs12(__VA_ARGS__)
//#define uStrs14(O1, ...)		(UINT)_S(O1),uStrs13(__VA_ARGS__)
//#define uStrs15(O1, ...)		(UINT)_S(O1),uStrs14(__VA_ARGS__)
//#define uStrs16(O1, ...)		(UINT)_S(O1),uStrs15(__VA_ARGS__)
//#define uStrs17(O1, ...)		(UINT)_S(O1),uStrs16(__VA_ARGS__)
//#define uStrs18(O1, ...)		(UINT)_S(O1),uStrs17(__VA_ARGS__)
//#define uStrs19(O1, ...)		(UINT)_S(O1),uStrs18(__VA_ARGS__)
//#define uStrs20(O1, ...)		(UINT)_S(O1),uStrs19(__VA_ARGS__)
//#define uStrs21(O1, ...)		(UINT)_S(O1),uStrs20(__VA_ARGS__)
...
//#define MENU_OUT(OUT_ON, CF, ...)		if(KEY_C && (giMenuDispPos == 0) && (OUT_ON)) { /*__VA_ARGS__*/  menu_out(CF); __VA_ARGS__ goto menu_start; }
// 170706 KSH
#define MENU_OUT(OUT_ON,CF, ...)      { if(KEY_C && (giMenuDispPos == 0) && (OUT_ON)) { /*__VA_ARGS__*/  menu_out(CF); __VA_ARGS__ goto menu_start; }\
                                        if(gbMnClose && (giMenuDispPos == 0)) { giLV = 0; menu_out(0); __VA_ARGS__ gbMnClose = 0; } }
...
//#define MENU_STRex(MENU_ON,VAL,NUM,LIST, ...)	menu_str(MENU_ON, &VAL, NUM, (const PEXCH**)_S(LIST));	MENU_DISABLE(MENU_ON)

//#define MENU_STR_LIST(NAME,NUM, ...)			const UINT _S(NAME)[NUM] = { uStrs##NUM(__VA_ARGS__) };
//#define MENU_STRex(MENU_ON,VAL,NUM,LIST, ...)	menu_str(MENU_ON, &VAL, NUM, (const PEXCH**)_S(LIST));
//#define MENU_STR(MENU_ON,VAL,NUM, ...)			if(NUM>14) { MENU_STRex(MENU_ON,VAL,NUM,__VA_ARGS__) } else { const PEXCH* __LIST[] = { S_LIST##NUM(__VA_ARGS__) }; menu_str(MENU_ON, &VAL, NUM, __LIST); }	MENU_DISABLE(MENU_ON)

#define MENU_STR(MENU_ON,VAL,NUM, ...)	const UINT __LIST[] = { S_LIST##NUM(UINT,__VA_ARGS__) }; menu_str(MENU_ON, &VAL, NUM, (const PEXCH**)__LIST);	MENU_DISABLE(MENU_ON)
...
#define MENU_EXT(TITLE,MENU_ON,OUT_ON,OUT_CODE, ...)\
	else if((MENU_TITLE == _S(TITLE)) && ((MENU_ON) || gbMnClose)) { menu_pos(_S(TITLE), 0, 0); if(giMenuDispChg) { giMenuDispChg = 0; __VA_ARGS__ }\
		MENU_OUT(OUT_ON, 0, OUT_CODE;)\
	}
#define MENU_SET(NUM,TITLE,MENU_ON,OUT_ON, ...)\
		else if((MENU_TITLE == _S(TITLE)) && ((MENU_ON) || gbMnClose)) { if(gbMnClose) gbStgPos[giLV] = NUM-1; MENU_SET_NUM(TITLE, NUM, __VA_ARGS__)\
			/*if(OUT_ON) {\
...
#define MENU_CHANGE()			{ menu_redraw(1,0); goto menu_start; } // NAME(메뉴 항목) 과 VAL(메뉴 설정값) 모두 다시 그림
#define MENU_REDRAW()			{ menu_redraw(0,0); goto menu_start; } // VAL만 다시 그리는데, GRAY는 NOT_USED
#define MENU_REDRAW_GRAY_ONLY()	{ menu_redraw(0,1); goto menu_start; } // VAL만 다시 그리는데, GRAY에 NOT_USED 안함
...
#define MENU_CLOSE()            gbMnClose = 1       // 170706 KSH
#define if_KEY_LR(...)			if(KEY_L || KEY_R) { __VA_ARGS__; }
#define if_STATUS_CHG(BF, MP, ...)	{if(MP != BF) {__VA_ARGS__;} BF = MP;}
...
#define ROI_POS(a,b)	(gbMnROICfg(MP(MPWdrROIZONE))->bPos##a##b##_Lo | (gbMnROICfg(MP(MPWdrROIZONE))->bPos##a##b##_Up<<8)) // 170719 PCB : for WDRROI polygon
#define	ROIInterp1D(dir,result_dir,set,a,b) 	LibUtlInterp1D(ROI_POS(set,dir), ROI_POS(a,dir), ROI_POS(b,dir), ROI_POS(a,result_dir), ROI_POS(b,result_dir))	 // 170911 PCB :  
