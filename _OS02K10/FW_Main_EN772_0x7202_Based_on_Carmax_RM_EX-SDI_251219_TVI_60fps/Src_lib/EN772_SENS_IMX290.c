/* **************************************************************************
 File Name	:	EN772_SENS_IMX290.c
 Description	:	EN772 - IMX290 device driver
 Designer		:	Lee, Hoon
...
// initial
	...
	const WORD gwTblSens0[][5] = {
								//ADDR	 Nor 2M30P	DOL 2P	Nor 2M60P	DOL2P
								/*ID2*/
								{0x3005, 	0x01,	0x00,	0x01, 		0x00}, 	// ADBIT					(Normal : 12bit / DOL : 10bit)
								...
								{0x3010, 	0x21,	0x61,	0x21, 		0x61}, 	// AGC config normal 0x21, each frame gain of DOL 0x61
...
//								{0x301c, 	0x30,	0x98,	0x98, 		0x4c}, 	// HMAX *											//30P <-> 60P
//								{0x301d, 	0x11,	0x08,	0x08, 		0x04}, 	// "													//30P <-> 60P
								...
								{0x3030, 	0x00,	0x07,	0x00, 		0x07}, 	// RHS1
								{0x3031, 	0x00,	0x00,	0x00, 		0x00}, 	// "
								{0x3032, 	0x00,	0x00,	0x00, 		0x00},	// "
								
								{0x3045, 	0x01,	0x05,	0x01, 		0x05},	// for DOL
...
//								{0x304b, 	0x0a,	0x0a,	0x0a, 		0x0a}, 	// XVSOUTSEL, XHSOUTSEL (V,H SYNC ON)
								...
								{0x3071, 	0x11,	0x11,	0x11, 		0x11}, 	// 
								{0x309b, 	0x10,	0x10,	0x10, 		0x10}, 	// 
								{0x309c, 	0x22,	0x22,	0x22, 		0x22}, 	// 
								{0x30a2, 	0x02,	0x02,	0x02, 		0x02}, 	// 
								{0x30a6, 	0x20,	0x20,	0x20, 		0x20}, 	// 
								{0x30a8, 	0x20,	0x20,	0x20, 		0x20}, 	// 
								{0x30aa, 	0x20,	0x20,	0x20, 		0x20}, 	// 
								{0x30ac, 	0x20,	0x20,	0x20, 		0x20}, 	// 
								{0x30b0, 	0x43,	0x43,	0x43, 		0x43},	//
								{0x30f0, 	0xf0,	0x64,	0xf0, 		0x64},	// S1 gain off
								         	
								/*ID3*/  	
								{0x3106, 	0x00,	0x15,	0x00, 		0x15}, 	// XVS,HVS subsampling when DOL (2p master : 0x15 / Sony Initial : 0x11)
								{0x3119, 	0x9e,	0x9e,	0x9e, 		0x9e}, 	// 
								{0x311c, 	0x1e,	0x1e,	0x1e, 		0x1e}, 	// 
								{0x311e, 	0x08,	0x08,	0x08, 		0x08}, 	// 
								{0x3128, 	0x05,	0x05,	0x05, 		0x05}, 	// 
								{0x3129, 	0x00,	0x1d,	0x00, 		0x1d}, 	// ADBIT1 (0x00 : 12bit, 0x1D : 10bit)
								{0x313d, 	0x83,	0x83,	0x83, 		0x83}, 	// 
								{0x3150, 	0x03,	0x03,	0x03, 		0x03}, 	// 
								{0x315e, 	0x1a,	0x1a,	0x1a, 		0x1a}, 	// INCKSEL5
								{0x3164, 	0x1a,	0x1a,	0x1a, 		0x1a}, 	// INCKSEL6
								{0x317c, 	0x00,	0x12,	0x00, 		0x12}, 	// ADBIT2 (0x00 : 12bit, 0x12 : 10bit)
								{0x317e, 	0x00,	0x00,	0x00, 		0x00},	// 
								{0x31a0, 	0xfc,	0xb4,	0xfc, 		0xb4},	// DOL 1080P 10b
								{0x31a1, 	0x00,	0x02,	0x00, 		0x02},	// "
								{0x31ec, 	0x0e,	0x37,	0x0e, 		0x37},	// ADBIT3 (0x0E : 12bit, 0x37 : 10bit)
                                         	
								/*ID4*/  	
								{0x32b8, 	0x50,	0x50,	0x50, 		0x50}, 	// 
								{0x32b9, 	0x10,	0x10,	0x10, 		0x10}, 	// 
								{0x32ba, 	0x00,	0x00,	0x00, 		0x00}, 	// 
								{0x32bb, 	0x04,	0x04,	0x04, 		0x04}, 	// 
								{0x32c8, 	0x50,	0x50,	0x50, 		0x50}, 	// 
								{0x32c9, 	0x10,	0x10,	0x10, 		0x10}, 	// 
								{0x32ca, 	0x00,	0x00,	0x00, 		0x00}, 	// 
								{0x32cb, 	0x04,	0x04,	0x04, 		0x04},	// 
								         	
								/*ID5*/  	
								{0x332c, 	0xd3,	0xd3,	0xd3, 		0xd3}, 	// 
								{0x332d, 	0x10,	0x10,	0x10, 		0x10}, 	// 
								{0x332e, 	0x0d,	0x0d,	0x0d, 		0x0d}, 	// 
								{0x3358, 	0x06,	0x06,	0x06, 		0x06}, 	// 
								{0x3359, 	0xe1,	0xe1,	0xe1, 		0xe1}, 	// 
								{0x335a, 	0x11,	0x11,	0x11, 		0x11}, 	// 
								{0x3360, 	0x1e,	0x1e,	0x1e, 		0x1e}, 	// 
								{0x3361, 	0x61,	0x61,	0x61, 		0x61}, 	// 
								{0x3362, 	0x10,	0x10,	0x10, 		0x10}, 	// 
								{0x33b0, 	0x50,	0x50,	0x50, 		0x50}, 	// 
								{0x33b2, 	0x1a,	0x1a,	0x1a, 		0x1a}, 	// 
								{0x33b3, 	0x04,	0x04,	0x04, 		0x04},	// 
								         	
								/*ID6*/  	
								{0x3405, 	0x10,	0x00,	0x00, 		0x00},	// REPETITION 			(0x20 : 222.75 /0x10 : 445.5 / 0x00 : 891Mbps/Lane)
								{0x3407, 	0x01,	0x01,	0x01, 		0x03},	// PHYSICAL_LANE_NUM 	(0x1 : 2 lane / 0x3 : 4 lane)
								{0x3414, 	0x0A,	0x0A,	0x0A, 		0x0A},	// OPB_SIZE_V
								{0x3415, 	0x01,	0x00,	0x01, 		0x00},	// DOL : 0x00				
								{0x3418, 	0x49,	0x9c,	0x49, 		0x9c},  // Y_OUT_SIZ 				(Full HD 1080p Normal : 0x449 / DOL2P : (1109 + (RHS1-1)/2) * 2))	Sony : 2M30P DOL - 0x8B0 / 2M60P DOL - 0x8B2
								{0x3419, 	0x04,	0x08,	0x04, 		0x08},  // "
								{0x3441, 	0x0C,	0x0A,	0x0C, 		0x0A},  // CSI_DT_FMT 			(0x0C : 12bit, 0x0A : 10bit)
								{0x3442, 	0x0C,	0x0A,	0x0C, 		0x0A},  // CSI_DT_FMT 			(0x0C : 12bit, 0x0A : 10bit)
								{0x3443, 	0x01,	0x01,	0x01, 		0x03},  // CSI_LANE_MODE		(0x1 : 2 lane / 0x3 : 4 lane)
								...
								{0x3472, 	0x9C,	0xA0,	0x9C, 		0xA0},  // X_OUT_SIZE			(Full HD 1080p Normal : 0x79C / DOL : 0x7A0)
								{0x3473, 	0x07,	0x07,	0x07, 		0x07},  // X_OUT_SIZE			(Full HD 1080p Normal : 0x79C / DOL : 0x7A0)
...
{	// MIPI RX Configuration
	LibISPtoSENS_Intf(\
					...
					(MIPI),\
					/* 1, 2, 4 LANE */\
					(((aiResMode==MD_2M_FPS_50_60)&&(aiWdrMode==MN_ON))?(_4LANE):(_2LANE)),\
					/* 12BIT or 10BIT */\
...
{	// IMX290
	...
	if(bInitSet){
		...
		if(bChipID==0x0)	{TxStrNoIRQ("Sensor correct matching. ", bChipID, 1);}
